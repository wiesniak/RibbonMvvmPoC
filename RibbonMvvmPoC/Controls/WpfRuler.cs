...
namespace WpfRuler
{
    ...
    public class PixelRuler : FrameworkElement
    {
        ...
        protected override void OnRender(DrawingContext drawingContext)
        {
            ...
            double rulerLength = Length*100/DipHelper.PixelUnitFactor.Cm;
            for (double dUnit = 0; dUnit < rulerLength; dUnit += SmallStep)
            {
                double d =  dUnit * this.Zoom * DipHelper.PixelUnitFactor.Cm / 100;
                ...
                if ((dUnit != 0.0) && (dUnit % Step == 0) && (dUnit < rulerLength))
                {
